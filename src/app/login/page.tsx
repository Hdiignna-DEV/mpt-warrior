          ...
          <div className="md:hidden flex flex-col items-center justify-center bg-slate-900 min-h-screen p-3">
            <div className="relative w-full max-w-sm">
              ...
              <div className="flex gap-3 items-end">
                {/* Secure Login Info Box - 3 parts - BOLD & VISIBLE */}
                <div className="flex-1 bg-blue-600/30 border-2 border-blue-400/50 rounded-lg p-3.5 backdrop-blur-sm shadow-lg shadow-blue-500/20">
                  <p className="font-bold text-blue-300 text-sm mb-1 flex items-center gap-1.5">
                    <Shield size={14} className="text-blue-400" /> Secure Login
                  </p>
