    ...
    <div className="fixed bottom-6 left-6 z-50 w-[450px] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 border-b border-red-500/30 p-4">
        ...
        <p className="text-xs text-slate-400 mt-2">
          Real-Time Economic Events - High Volatility Expected
        </p>
      </div>
      ...
      <div className="bg-slate-950">
        <iframe
          src="https://sslecal2.investing.com?columns=exc_flags,exc_currency,exc_importance,exc_actual,exc_forecast,exc_previous&features=datepicker,timezone&countries=25,32,6,37,72,22,17,39,14,10,35,43,56,36,110,11,26,12,4,5&calType=day&timeZone=55&lang=1"
          width="100%"
          height="467"
          frameBorder="0"
